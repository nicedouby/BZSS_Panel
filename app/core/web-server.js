Warning: truncated output (original token count: 59588)
Total output lines: 6517
...
export class WebServer {
  ...
  async handleApi(url, req, res) {
    ...
    if (url.pathname.startsWith("/api/plugins/welcome-join-warning")) {
      ...
      if (url.pathname === "/api/plugins/welcome-join-warni…9588 tokens truncated…is.json(res, 404, { error: "PluginNotLoaded" });
