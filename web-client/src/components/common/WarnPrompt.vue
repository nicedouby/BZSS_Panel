...
.warning-composer{width:min(900px,100%);max-height:min(760px,calc(var(--app-viewport-height) - 40px));display:flex;flex-direction:column;overflow:hidden;border:1px solid rgba(251,191,36,.25);border-radius:20px;background:linear-gradient(145deg,rgba(255,255,255,.045),transparent 42%),var(--color-bg-card);box-shadow:0 28px 90px #000a,0 0 34px rgba(245,158,11,.09)}
