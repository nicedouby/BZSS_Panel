...
.server-playtime-list{display:grid;gap:8px}.server-playtime-item{display:flex;align-items:center;justify-content:space-between;gap:14px;padding:11px 12px;border:1px solid var(--color-border-default);border-radius:10px;background:rgba(255,255,255,.022)}.server-playtime-item strong,.server-playtime-item small{display:block}.server-playtime-item strong{font-size:13px;word-break:break-all}.server-playtime-item small,.empty-history{margin-top:4px;font-size:11px;color:var(--color-text-muted)}.server-playtime-item>b{color:#8acaff;white-space:nowrap}.empty-history{padding:13px;border:1px dashed var(--color-border-default);border-radius:10px}
</style>
