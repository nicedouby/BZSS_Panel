...
// Keep the asset table static. Vite's import.meta.glob option parser uses
// Function() internally, which is unavailable when Node runs with
// --disallow-code-generation-from-strings. Static URL expressions are
// transformed by Vite without that code-generation path.
const assetUrlsByBasename: Record<string, string> = {
  "ADF.PNG": new URL("./ADF.PNG", import.meta.url).href,
  "AFU.PNG": new URL("./AFU.PNG", import.meta.url).href,
  "BAF.PNG": new URL("./BAF.PNG", import.meta.url).href,
  "CAF.PNG": new URL("./CAF.PNG", import.meta.url).href,
  "CRF.PNG": new URL("./CRF.PNG", import.meta.url).href,
  "GFI.PNG": new URL("./GFI.PNG", import.meta.url).href,
  "IMF.PNG": new URL("./IMF.PNG", import.meta.url).href,
  "MEI.PNG": new URL("./MEI.PNG", import.meta.url).href,
  "PLA.PNG": new URL("./PLA.PNG", import.meta.url).href,
  "PLAAGF.PNG": new URL("./PLAAGF.PNG", import.meta.url).href,
  "PLANMC.png": new URL("./PLANMC.png", import.meta.url).href,
  "RGF.PNG": new URL("./RGF.PNG", import.meta.url).href,
  "TLF.PNG": new URL("./TLF.PNG", import.meta.url).href,
  "T_ADF_1RAR_Mechanized.PNG": new URL("./T_ADF_1RAR_Mechanized.PNG", import.meta.url).href,
  "T_ADF_1st_Regiment_Armored.PNG": new URL("./T_ADF_1st_Regiment_Armored.PNG", import.meta.url).href,
  "T_ADF_2RAR_LightInfantry.PNG": new URL("./T_ADF_2RAR_LightInfantry.PNG", import.meta.url).href,
  "T_ADF_3RAR_AirAssault.PNG": new URL("./T_ADF_3RAR_AirAssault.PNG", import.meta.url).href,
  "T_ADF_3rd_Brigade_CombinedArms.PNG": new URL("./T_ADF_3rd_Brigade_CombinedArms.PNG", import.meta.url).href,
  "T_ADF_3rd_Combat_Service_Support.PNG": new URL("./T_ADF_3rd_Combat_Service_Support.PNG", import.meta.url).href,
  "T_ADF_5RAR_Motorized.PNG": new URL("./T_ADF_5RAR_Motorized.PNG", import.meta.url).href,
  "T_AFU_10thMAB_LightInfantry.PNG": new URL("./T_AFU_10thMAB_LightInfantry.PNG", import.meta.url).href,
  "T_AFU_11thAC_CombinedArms.PNG": new URL("./T_AFU_11thAC_CombinedArms.PNG", import.meta.url).href,
  "T_AFU_148thAB_Support.PNG": new URL("./T_AFU_148thAB_Support.PNG", import.meta.url).href,
  "T_AFU_1stTB_Armored.PNG": new URL("./T_AFU_1stTB_Armored.PNG", import.meta.url).href,
  "T_AFU_28thMB_Mechanized.PNG": new URL("./T_AFU_28thMB_Mechanized.PNG", import.meta.url).href,
  "T_AFU_35thMB_AmphibiousAssault.PNG": new URL("./T_AFU_35thMB_AmphibiousAssault.PNG", import.meta.url).href,
  "T_AFU_58thIMIB_Motorized.PNG": new URL("./T_AFU_58thIMIB_Motorized.PNG", import.meta.url).href,
  "T_AFU_95thAAB_AirAssault.PNG": new URL("./T_AFU_95thAAB_AirAssault.PNG", import.meta.url).href,
  "T_BAF_1_YORKS_Mechanized.PNG": new URL("./T_BAF_1_YORKS_Mechanized.PNG", import.meta.url).href,
  "T_BAF_2_BPR_AirAssault.PNG": new URL("./T_BAF_2_BPR_AirAssault.PNG", import.meta.url).href,
  "T_BAF_3DIV_CombinedArms.PNG": new URL("./T_BAF_3DIV_CombinedArms.PNG", import.meta.url).href,
  "T_BAF_3_RIFLES_Motorized.PNG": new URL("./T_BAF_3_RIFLES_Motorized.PNG", import.meta.url).href,
  "T_BAF_QRH_Armored.PNG": new URL("./T_BAF_QRH_Armored.PNG", import.meta.url).href,
  "T_BAF_ROYALLOGI_Support.PNG": new URL("./T_BAF_ROYALLOGI_Support.PNG", import.meta.url).href,
  "T_CAF_12e_Regiment_Motorized.PNG": new URL("./T_CAF_12e_Regiment_Motorized.PNG", import.meta.url).href,
  "T_CAF_1_CMBG_CombinedArms.PNG": new URL("./T_CAF_1_CMBG_CombinedArms.PNG", import.meta.url).href,
  "T_CAF_3_PPCLI_LightInfantry.PNG": new URL("./T_CAF_3_PPCLI_LightInfantry.PNG", import.meta.url).href,
  "T_CAF_3_RCR_AirAssault.PNG": new URL("./T_CAF_3_RCR_AirAssault.PNG", import.meta.url).href,
  "T_CAF_CCSB_Support.PNG": new URL("./T_CAF_CCSB_Support.PNG", import.meta.url).href,
  "T_CAF_LdSH_Armored.PNG": new URL("./T_CAF_LdSH_Armored.PNG", import.meta.url).href,
  "T_CAF_R_NFLD_Reserve.PNG": new URL("./T_CAF_R_NFLD_Reserve.PNG", import.meta.url).href,
  "T_CAF_TheWesties_.PNG": new URL("./T_CAF_TheWesties_.PNG", import.meta.url).href,
  "T_CAF_VanDoos_Mechanized.PNG": new URL("./T_CAF_VanDoos_Mechanized.PNG", import.meta.url).href,
  "T_GFI_16thAD_Armored.PNG": new URL("./T_GFI_16thAD_Armored.PNG", import.meta.url).href,
  "T_GFI_21stD_CombinedArms.PNG": new URL("./T_GFI_21stD_CombinedArms.PNG", import.meta.url).href,
  "T_GFI_30thID_Motorized.PNG": new URL("./T_GFI_30thID_Motorized.PNG", import.meta.url).href,
  "T_GFI_55thAB_AirAssault.PNG": new URL("./T_GFI_55thAB_AirAssault.PNG", import.meta.url).href,
  "T_GFI_64thID_LightInfantry.PNG": new URL("./T_GFI_64thID_LightInfantry.PNG", import.meta.url).href,
  "T_GFI_75thLB_Support.PNG": new URL("./T_GFI_75thLB_Support.PNG", import.meta.url).href,
  "T_GFI_77thID_Mechanized.PNG": new URL("./T_GFI_77thID_Mechanized.PNG", import.meta.url).href,
  "T_IMF_Armored.PNG": new URL("./T_IMF_Armored.PNG", import.meta.url).href,
  "T_IMF_BattleGroup_CombinedArms.PNG": new URL("./T_IMF_BattleGroup_CombinedArms.PNG", import.meta.url).href,
  "T_IMF_LightInfantry.PNG": new URL("./T_IMF_LightInfantry.PNG", import.meta.url).href,
  "T_IMF_Mechanized.PNG": new URL("./T_IMF_Mechanized.PNG", import.meta.url).href,
  "T_IMF_Motorized.PNG": new URL("./T_IMF_Motorized.PNG", import.meta.url).href,
  "T_IMF_Support.PNG": new URL("./T_IMF_Support.PNG", import.meta.url).href,
  "T_MEA_1st_LegionofBabylon_CombinedArms.PNG": new URL("./T_MEA_1st_LegionofBabylon_CombinedArms.PNG", import.meta.url).href,
  "T_MEA_2nd_Vizir_Hussein_Support.PNG": new URL("./T_MEA_2nd_Vizir_Hussein_Support.PNG", import.meta.url).href,
  "T_MEA_3rd_King_Qadesh_Mechanized.PNG": new URL("./T_MEA_3rd_King_Qadesh_Mechanized.PNG", import.meta.url).href,
  "T_MEA_4th_Border_Guard_LightInfantry.PNG": new URL("./T_MEA_4th_Border_Guard_LightInfantry.PNG", import.meta.url).href,
  "T_MEA_60th_Prince_Assur_Armored.PNG": new URL("./T_MEA_60th_Prince_Assur_Armored.PNG", import.meta.url).href,
  "T_MEA_83rd_Prince_Zaid_Motorized.PNG": new URL("./T_MEA_83rd_Prince_Zaid_Motorized.PNG", import.meta.url).href,
  "T_MEA_91st_Battalion_AirAssault.PNG": new URL("./T_MEA_91st_Battalion_AirAssault.PNG", import.meta.url).href,
  "T_MEI_Armored.PNG": new URL("./T_MEI_Armored.PNG", import.meta.url).href,
  "T_MEI_BattleGrp_CombinedArms.PNG": new URL("./T_MEI_BattleGrp_CombinedArms.PNG", import.meta.url).href,
  "T_MEI_LightInfantry.PNG": new URL("./T_MEI_LightInfantry.PNG", import.meta.url).href,
  "T_MEI_Mechanized.PNG": new URL("./T_MEI_Mechanized.PNG", import.meta.url).href,
  "T_MEI_Motorized.PNG": new URL("./T_MEI_Motorized.PNG", import.meta.url).href,
  "T_MEI_Support.PNG": new URL("./T_MEI_Support.PNG", import.meta.url).href,
  "T_PLAAGF_10th_Light_Battalion_LightInfantry.PNG": new URL("./T_PLAAGF_10th_Light_Battalion_LightInfantry.PNG", import.meta.url).href,
  "T_PLAAGF_14th_Brigade_CombinedArms.PNG": new URL("./T_PLAAGF_14th_Brigade_CombinedArms.PNG", import.meta.url).href,
  "T_PLAAGF_4th_Medium_Battalion_Mechanized.PNG": new URL("./T_PLAAGF_4th_Medium_Battalion_Mechanized.PNG", import.meta.url).href,
  "T_PLAAGF_9th_Heavy_Battalion_Armored.PNG": new URL("./T_PLAAGF_9th_Heavy_Battalion_Armored.PNG", import.meta.url).href,
  "T_PLANMC_17th_MarineBattalion_Support.PNG": new URL("./T_PLANMC_17th_MarineBattalion_Support.PNG", import.meta.url).href,
  "T_PLANMC_3rd_Heavy_Battalion_Armored.PNG": new URL("./T_PLANMC_3rd_Heavy_Battalion_Armored.PNG", import.meta.url).href,
  "T_PLANMC_4th_SpecialCombatBattalion_LightInfantry.PNG": new URL("./T_PLANMC_4th_SpecialCombatBattalion_LightInfantry.PNG", import.meta.url).href,
  "T_PLANMC_5th_MarineBrigade_CombinedArms.PNG": new URL("./T_PLANMC_5th_MarineBrigade_CombinedArms.PNG", import.meta.url).href,
  "T_PLANMC_7th_Medium_Battalion_Motorized.PNG": new URL("./T_PLANMC_7th_Medium_Battalion_Motorized.PNG", import.meta.url).href,
  "T_PLA_112th_Brigade_Motorized.PNG": new URL("./T_PLA_112th_Brigade_Motorized.PNG", import.meta.url).href,
  "T_PLA_118th_Brigade_CombinedArms.PNG": new URL("./T_PLA_118th_Brigade_CombinedArms.PNG", import.meta.url).href,
  "T_PLA_149th_Brigade_LightInfantry.PNG": new URL("./T_PLA_149th_Brigade_LightInfantry.PNG", import.meta.url).href,
  "T_PLA_161st_Brigade_AirAssault.PNG": new URL("./T_PLA_161st_Brigade_AirAssault.PNG", import.meta.url).href,
  "T_PLA_195th_Brigade_Armored.PNG": new URL("./T_PLA_195th_Brigade_Armored.PNG", import.meta.url).href,
  "T_PLA_80th_Brigade_Support.PNG": new URL("./T_PLA_80th_Brigade_Support.PNG", import.meta.url).href,
  "T_RGF_1398th_Recon_LightInfantry.PNG": new URL("./T_RGF_1398th_Recon_LightInfantry.PNG", import.meta.url).href,
  "T_RGF_205th_OMSBr_Mechanized.PNG": new URL("./T_RGF_205th_OMSBr_Mechanized.PNG", import.meta.url).href,
  "T_RGF_336th_GNIBr_AmphibiousAssault.PNG": new URL("./T_RGF_336th_GNIBr_AmphibiousAssault.PNG", import.meta.url).href,
  "T_RGF_3rd_Mtr_Div_Motorized.PNG": new URL("./T_RGF_3rd_Mtr_Div_Motorized.PNG", import.meta.url).href,
  "T_RGF_49th_OA_CombinedArms.PNG": new URL("./T_RGF_49th_OA_CombinedArms.PNG", import.meta.url).href,
  "T_RGF_6th_OTBr_Armored.PNG": new URL("./T_RGF_6th_OTBr_Armored.PNG", import.meta.url).href,
  "T_RGF_78th_OBrMTO_Support.PNG": new URL("./T_RGF_78th_OBrMTO_Support.PNG", import.meta.url).href,
  "T_TLF_1st_Army_CombinedArms.PNG": new URL("./T_TLF_1st_Army_CombinedArms.PNG", import.meta.url).href,
  "T_TLF_1st_Cmdo_Brigade_AirAssault.PNG": new URL("./T_TLF_1st_Cmdo_Brigade_AirAssault.PNG", import.meta.url).href,
  "T_TLF_2nd_BorderBrigade_LightInfantry.PNG": new URL("./T_TLF_2nd_BorderBrigade_LightInfantry.PNG", import.meta.url).href,
  "T_TLF_4th_ArmoredBrigade_Armored.PNG": new URL("./T_TLF_4th_ArmoredBrigade_Armored.PNG", import.meta.url).href,
  "T_TLF_51st_MotorInf_Brigade_Motorized.PNG": new URL("./T_TLF_51st_MotorInf_Brigade_Motorized.PNG", import.meta.url).href,
  "T_TLF_66th_MechInfBrigade_Mechanized.PNG": new URL("./T_TLF_66th_MechInfBrigade_Mechanized.PNG", import.meta.url).href,
  "T_TLF_LandForcesLogiCmd_Support.PNG": new URL("./T_TLF_LandForcesLogiCmd_Support.PNG", import.meta.url).href,
  "T_USA_10th_MTN_LightInfantry.PNG": new URL("./T_USA_10th_MTN_LightInfantry.PNG", import.meta.url).href,
  "T_USA_1st_Cav_Mechanized.PNG": new URL("./T_USA_1st_Cav_Mechanized.PNG", import.meta.url).href,
  "T_USA_1st_INFDIV_CombinedArms.PNG": new URL("./T_USA_1st_INFDIV_CombinedArms.PNG", import.meta.url).href,
  "T_USA_2nd_CAV_Motorized.PNG": new URL("./T_USA_2nd_CAV_Motorized.PNG", import.meta.url).href,
  "T_USA_37th_ArmorRegiment_Armored.PNG": new URL("./T_USA_37th_ArmorRegiment_Armored.PNG", import.meta.url).href,
  "T_USA_497th_CSSB_Support.PNG": new URL("./T_USA_497th_CSSB_Support.PNG", import.meta.url).href,
  "T_USA_504th_PIR_AirAssault.PNG": new URL("./T_USA_504th_PIR_AirAssault.PNG", import.meta.url).href,
  "T_USMC_1-1stMarines_LightInfantry.PNG": new URL("./T_USMC_1-1stMarines_LightInfantry.PNG", import.meta.url).href,
  "T_USMC_1st_TNK_BN_Armored.PNG": new URL("./T_USMC_1st_TNK_BN_Armored.PNG", import.meta.url).href,
  "T_USMC_2nd_MLG_Support.PNG": new URL("./T_USMC_2nd_MLG_Support.PNG", import.meta.url).href,
  "T_USMC_3-2nd_Marines_AirAssault.PNG": new URL("./T_USMC_3-2nd_Marines_AirAssault.PNG", import.meta.url).href,
  "T_USMC_31st_MEU_CombinedArms.PNG": new URL("./T_USMC_31st_MEU_CombinedArms.PNG", import.meta.url).href,
  "T_USMC_3rd_LAR_BN_Motorized.PNG": new URL("./T_USMC_3rd_LAR_BN_Motorized.PNG", import.meta.url).href,
  "T_USMC_4th_MARG_AmphibiousAssault.PNG": new URL("./T_USMC_4th_MARG_AmphibiousAssault.PNG", import.meta.url).href,
  "T_VDV_104th_Tank_Battalion_Armored.PNG": new URL("./T_VDV_104th_Tank_Battalion_Armored.PNG", import.meta.url).href,
  "T_VDV_108th_Guards_AirAssault.PNG": new URL("./T_VDV_108th_Guards_AirAssault.PNG", import.meta.url).href,
  "T_VDV_150th_Batallion_Support.PNG": new URL("./T_VDV_150th_Batallion_Support.PNG", import.meta.url).href,
  "T_VDV_173rd_Guards_LightInfantry.PNG": new URL("./T_VDV_173rd_Guards_LightInfantry.PNG", import.meta.url).href,
  "T_VDV_217th_Guards_AirAssaut.PNG": new URL("./T_VDV_217th_Guards_AirAssaut.PNG", import.meta.url).href,
  "T_VDV_7th_Guards_CombinedArms.PNG": new URL("./T_VDV_7th_Guards_CombinedArms.PNG", import.meta.url).href,
  "T_WPMC_ManticoreSecurityTaskForce_CombinedArms.PNG": new URL("./T_WPMC_ManticoreSecurityTaskForce_CombinedArms.PNG", import.meta.url).href,
  "T_WPMC_MinotaurSolutionsPatrolGroup_LightInfantry.PNG": new URL("./T_WPMC_MinotaurSolutionsPatrolGroup_LightInfantry.PNG", import.meta.url).href,
  "T_WPMC_MurkWaterAirWing_AirAssault.PNG": new URL("./T_WPMC_MurkWaterAirWing_AirAssault.PNG", import.meta.url).href,
  "T_WPMC_Overwatch6PatrolGroup_LightInfantry.PNG": new URL("./T_WPMC_Overwatch6PatrolGroup_LightInfantry.PNG", import.meta.url).href,
  "USA.PNG": new URL("./USA.PNG", import.meta.url).href,
  "USMC.PNG": new URL("./USMC.PNG", import.meta.url).href,
  "VDV.png": new URL("./VDV.png", import.meta.url).href,
  "WPMC.PNG": new URL("./WPMC.PNG", import.meta.url).href,
};
