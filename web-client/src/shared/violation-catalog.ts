export interface ViolationWarningItem {
  key: string;
  label: string;
  warningText: string;
}

export interface ViolationWarningCategory {
  key: string;
  label: string;
  items: ViolationWarningItem[];
}

export const violationWarningCatalog: ViolationWarningCategory[] = [
  { key: "main_camping", label: "压家警告", items: [
  ...
  { key: "solo_vehicle", label: "违规单载警告", items: [
    { key: "solo_vehicle", label: "违规单载", warningText: "违规单载警告" },
  ] },
  { key: "wandering", label: "郊游警告", items: [
  ...
  { key: "invalid_vehicle_claim", label: "违规认领载具警告", items: [
    { key: "invalid_vehicle_claim", label: "违规认领载具", warningText: "违规认领载具警告" },
  ] },
  { key: "invalid_squad_creation", label: "违规建队警告", items: [
    { key: "invalid_mortar_squad", label: "攻守模式建立迫击炮队", warningText: "违规迫击炮建队" },
  ] },
  { key: "abuse_main_base_protection", label: "违规利用压家保护警告", items: [
  ...
  { key: "invalid_squad_loadout", label: "队装不规范警告", items: [
  ...
  { key: "failure_squad_duty", label: "不履行队伍性质义务警告", items: [
