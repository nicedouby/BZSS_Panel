...
const COMMAND_PERMISSION_ALIASES = new Map([
  ...
  ["adminwarn", "rcon.warn"],
  ["adminkick", "rcon.kick"],
  ["adminnorespawntimer", "rcon.tb"],
  ["adminforceallvehicleavailability", "rcon.tb"],
  ["adminforceallroleavailability", "rcon.tb"],
  ["admindisablevehiclekitrequirement", "rcon.tb"],
  ["admindisablevehicleclaiming", "rcon.tb"],
  ["admindisablevehicleteamrequirement", "rcon.tb"],
  ["adminforcealldeployableavailability", "rcon.tb"],
