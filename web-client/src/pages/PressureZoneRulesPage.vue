...
import { broadcastPressureZoneRule, fetchPressureZoneRulesState, setPressureZoneRulesEnabled, type PressureZoneRulesState } from "../app/pressureZoneRulesApi";
...
<style scoped>
.pressure-rule-page{padding:24px;max-width:1180px;margin:0 auto;color:#dbeafe}.page-header{display:flex;justify-content:space-between;gap:20px;align-items:flex-start;margin-bottom:20px}.eyebrow{color:#5eead4;font-size:11px;letter-spacing:.12em}.page-header h1{margin:4px 0 8px}.page-header p{color:#94a3b8}.button{border:1px solid #334155;border-radius:8px;padding:9px 13px;background:#0f172a;color:#dbeafe;cursor:pointer}.button.primary{border-color:#22d3ee;background:#164e63}.button.ghost{background:#1e293b}.button.danger{border-color:#f59e0b;color:#fde68a}.button:disabled{opacity:.55;cursor:wait}.current-card,.announcement-card,.temporary-card,.rule-card{min-width:0;border:1px solid rgba(148,163,184,.2);border-radius:12px;background:rgba(15,23,42,.72);padding:16px}.current-card{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-bottom:14px}.current-card span,.current-card small{display:block;color:#64748b;font-size:11px}.current-card strong{display:block;margin-top:5px;color:#f8fafc;overflow-wrap:anywhere}.current-card.unknown{border-color:#f59e0b}.announcement-card{margin-bottom:14px}.announcement-card h2,.temporary-card h2,.rule-card h2{margin:0 0 10px;font-size:15px}.announcement-card pre{white-space:pre-wrap;margin:0;color:#a7f3d0;font:inherit;line-height:1.7;overflow-wrap:anywhere}.error{color:#fca5a5}.rule-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin-bottom:14px}.rule-card.active{border-color:#22d3ee;box-shadow:0 0 0 1px rgba(34,211,238,.25)}.rule-card p,.temporary-card p{margin:0;color:#cbd5e1;line-height:1.7}.temporary-card p+p{margin-top:8px}@media(max-width:760px){.page-header{display:block}.page-header .button{margin-top:10px}.current-card,.rule-grid{grid-template-columns:1fr}}@media(max-width:640px){.pressure-rule-page{padding:10px}.current-card,.announcement-card,.temporary-card,.rule-card{padding:12px}.page-header{margin-bottom:12px}.page-header .button{width:100%}}
</style>
