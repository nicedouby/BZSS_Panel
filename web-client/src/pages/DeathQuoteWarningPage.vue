    ...
    <section class="control-panel">
      ...
      <div class="probability-card">
        <div class="probability-head">
          <div><p class="eyebrow">每次 Kill 触发概率</p><label class="probability-input"><input v-model.number="draft.triggerProbabilityPercent" type="number" inputmode="numeric" min="0" max="100" @blur="normalizeProbability"><small>%</small></label></div>
      ...
      <PageCard class="quote-card">
        ...
        <div class="quote-list">
          <article v-for="(quote, index) in draft.quotes" :key="quote.id" class="quote-row" :class="{ disabled: !quote.enabled }">
            ...
            <textarea v-model="quote.text" maxlength="180" rows="2" placeholder="输入死亡后显示给玩家的名言（支持 Shift+Enter 或 Enter 换行）"></textarea>
