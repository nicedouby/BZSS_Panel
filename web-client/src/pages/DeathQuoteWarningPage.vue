    ...
    <section class="control-panel">
      ...
      <div class="probability-card">
        <div class="probability-head">
          <div class="probability-field"><p class="eyebrow">每次 Kill 触发概率</p><label for="death-quote-probability">概率</label><div class="number-control"><input id="death-quote-probability" v-model.number="draft.triggerProbabilityPercent" type="number" inputmode="numeric" min="0" max="100" @blur="normalizeProbability"><span>%</span></div></div>
        ...
        <div class="quote-list">
          <article v-for="(quote, index) in draft.quotes" :key="quote.id" class="quote-row" :class="{ disabled: !quote.enabled }">
            <header class="quote-row-head">
              ...
              <label class="quote-switch"><input v-model="quote.enabled" type="checkbox"><span>{{ quote.enabled ? "已启用" : "已停用" }}</span></label>
